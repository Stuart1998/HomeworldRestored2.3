...
Ship = {
	battleTimeOutTime				= 1.0,				-- Don't tweak this if you don't know what you are doing. takes 1 second to say that you're not in a battle anymore, while you are in battle you can't be cloaked, you are also visible always to the player you are firing at
