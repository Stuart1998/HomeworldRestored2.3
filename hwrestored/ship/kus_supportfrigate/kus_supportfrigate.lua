...
function Create_Kus_SupLatchDock(CustomGroup, playerIndex, shipID)
	SobGroup_Create("LatchDockTempGroup"..shipID)
	SobGroup_CreateIfNotExist("LatchDockTempGroup")
end

function Update_Kus_SupLatchDock(CustomGroup, playerIndex, shipID)
...
function Destroy_Kus_SupLatchDock(CustomGroup, playerIndex, shipID)
